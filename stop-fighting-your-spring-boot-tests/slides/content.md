...
Go to [menti.com](https://www.menti.com/) and use the code **2578 7937** to **anonymously** submit answers for the quizzes and add your questions during the talk.
...
<!-- header: 'Nürnberger Versicherung 03.12.2025 - Audience Questions, Raffle and Q&A @ menti.com Code: <strong>2578 7937</strong>' -->
...
Langsame builds, Spring Boot komplexität, AI-tested code
...
Part 3: Why Spring Boot Tests Fight Back
